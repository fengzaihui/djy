...
<tr><td VALIGN=TOP width="626"><h2 align=center>电脑小百科：PDF分割/合并工具</h2>

<h6></h6>
<hr>
	<p>PDF Split and Merge是个免费、简单、好上手原则的PDF工具，它不仅有中文介面，而且几乎不用任何学习就可以很快的完成PDF页面分割与合并。可以将多个PDF档合并成单一档案，切割的功能方面，可以设定从第几页后开始切割出来、每隔N页自动切割、切割出偶数页/奇数页等等，程式开放原始码，使用Java程式撰写，可跨平台支援各种作业系统。</p>
<p>PDF Split and Merge小档案</p>
<p>》软体名称：PDF Split and Merge</p>
<p>》软体性质：Freeware</p>
<p>》版本代码：2.2.0</p>
<p>》作业系统：Windows、Mac</p>
<p>》档案大小：12.66MB</p>
<p>》语言介面：中文</p>
<p>》官方网站：http://www.pdfsam.org/ </p>
<p>》下载网页：http://azo-freeware.blogspot.com/2007/11/pdf-split-and-merge-07sr1.md#1 </p>
<p><!--image v 1.0--></p>
<div style="line-height: 90%; text-align: center;">
	<ahref=" https://i.epochtimes.com/assets/uploads/2010/06/1006250821372184-450x358.png" target="_blank" rel="noreferrer noopener"></a><br /><span class="bn12"></span></div>
<p><!-- --></p>
<p>01.在下载页面可以看到免安装（Zip archive）与安装版（Win32 installer）。假设你和我一样下载了免安装版，直接解压缩，然后执行里面的“pdfsam-starter.exe”即可。</p>
<p><!--image v 1.0--></p>
<div style="line-height: 90%; text-align: center;">
	<ahref=" https://i.epochtimes.com/assets/uploads/2010/06/1006250823062184-450x387.png" target="_blank" rel="noreferrer noopener"></a><br /><span class="bn12"></span></div>
<p><!-- --></p>
<p>02.开启后先切换到〔Settings〕标签页面，然后在“Language”中切换到繁体（Traditional）或简体（Simplified）中文，按下右下方的〔Save〕，先退出PDFSAM再进入，便可以看到中文的介面了。</p>
<p><!--image v 1.0--></p>
<div style="line-height: 90%; text-align: center;">
	<ahref=" https://i.epochtimes.com/assets/uploads/2010/06/1006250824272184-450x389.png" target="_blank" rel="noreferrer noopener"></a><br /><span class="bn12"></span></div>
<p><!-- --></p>
<p>03.在〔merge〕活页标签中可以进行PDF档案的合并，只要将你想要合并的档案用〔新增〕来加入，并调整合并后的排列顺序，在〔浏览〕中选择要输出的资料夹档名或要合并到哪一个档案上，最后按下〔执行〕即可。</p>
<p><!--image v 1.0--></p>
<div style="line-height: 90%; text-align: center;">
	<ahref=" https://i.epochtimes.com/assets/uploads/2010/06/1006250825262184-450x420.png" target="_blank" rel="noreferrer noopener"></a><br /><span class="bn12"></span></div>
<p><!-- --></p>
<p>04.在〔Split〕活页标签中，先指定一个“原始档案”，然后选择一种分割的方式，设定输出的资料夹和档名前缀，最后也是按下〔执行〕即可完成作业。</p>
<p><!--image v 1.0--></p>
<div style="line-height: 90%; text-align: center;">
	<ahref=" https://i.epochtimes.com/assets/uploads/2010/06/1006250816512184-450x415.png" target="_blank" rel="noreferrer noopener"></a><br /><span class="bn12"></span></div>
<p><!-- --></p>
<p>摘编 自 《电脑人PCuSER 网路e周报》 PCuSER电脑人 提供 @<br /> <font color=#ffffff>(http://www.dajiyuan.com)</font></p>
...
<li><a href="https://github.com/dmdccu385/djy/blob/master/gb/21/8/20/n13176091.md#1">每天重复同样目标 90天后你的人生焕然一新</a></li>
<hr>
