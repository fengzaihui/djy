...
<style type="text/css">
	...
	#main{
		...
		text-align: center;/*盒子里的内容居中*/
		border: solid 1px;/*盒子边框*/
		border-radius: 20px;/*盒子的弧度*/
		background-color: bisque;/*盒子的背景色*/
		box-shadow: darkgrey 10px 10px 30px 10px;/*边框阴影*/
	}
	.p{font-size: 32px;}
	...
	#content{
		width: 80%;/*宽度*/
		margin: 5px auto;/*顶部间隔2px并居中*/
	}
	#content span:hover{/*文字层span标签伪类，鼠标移动到文字上会放大字体*/
		font-size: 18px;/*字体大小*/
	}
	#content a:hover{/*文字层a标签伪类，鼠标移动到a标签的文字会放大且背景颜色变为黄色*/
		font-size: 20px;/*字体大小*/
		background-color: greenyellow;/*背景颜色greenyellow(绿色黄)*/
	}
	...
	#music:hover{/*音乐层伪类，鼠标移动到上面会在2秒内旋转360度*/
		transform: rotate(360deg);/*旋转360度*/
		transition: 2s;/*两秒*/
	}
	table{/*表格标签*/
		text-align: center;/*表格内容居中*/
		border: solid 1px;/*表格边框*/
		border-radius: 20px;/*表格弧度*/
	}
	audio{border-radius: 15px;height: 30px;}
</style>
<div id="main">
	<div class="p">@</div>
	<div id="content">
		<span>Hi.朋友您好！</span><hr/>
		<span>这封邮件是随机发送的</span><hr >
		<span>全世界有七十多亿人</span><hr >
		<span>您能收到这封邮件真是有缘</span><hr >
		<span>您是否听说过三退保平安呢？</span><hr >
		<span>不妨在此了解一下吧>>><a href="https://myzhenyan.github.io/kanzx" target="_blank"><b>前往了解三退</b></a></span><hr >
		<span>打开天窗，看一看外面的世界>>><a href="https://myzhenyan.github.io/kanzx/fq" target="_blank"><b>翻墙工具</b></a></span><hr >
	</div>
	<div id="music">
		<table>
			<tr><td>送您一首美妙的音乐</td></tr><!--表格第一行-->
			<tr><th>《荷塘清音》</th></tr><!--表格第二行且加粗-->
			<tr><td><audio src="https://myzhenyan.github.io/kanzx/music/%E8%8D%B7%E5%A1%98%E6%B8%85%E9%9F%B3.mp3" controls="controls" autoplay="">当前浏览器不支持audio播放音乐</audio></td></tr><!--表格第三行放音乐-->
		</table>
	</div>
</div>
